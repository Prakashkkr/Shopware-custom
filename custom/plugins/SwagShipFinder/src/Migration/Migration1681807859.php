...
class Migration1681807859 extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        ...
        KEY `fk.swag_ship_finder.country_state_id` (`country_state_id`),
        ...
        CONSTRAINT `fk.swag_ship_finder.country_state_id` FOREIGN KEY (`country_state_id`) REFERENCES `country_state` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
