CREATE TABLE `blog_finder` (
    ...
    PRIMARY KEY (`id`),
    CONSTRAINT `json.blog_finder.translated` CHECK (JSON_VALID(`translated`)),
    KEY `fk.blog_finder.blog_category_id` (`blog_category_id`),
    CONSTRAINT `fk.blog_finder.blog_category_id` FOREIGN KEY (`blog_category_id`) REFERENCES `blog_category` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
CREATE TABLE `blog_finder_translation` (
    ...
    CONSTRAINT `fk.blog_finder_translation.blog_finder_id` FOREIGN KEY (`blog_finder_id`) REFERENCES `blog_finder` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT `fk.blog_finder_translation.language_id` FOREIGN KEY (`language_id`) REFERENCES `language` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `blog_finder_mapping` (
    ...
    CONSTRAINT `fk.blog_finder_mapping.product_id` FOREIGN KEY (`product_id`,`product_version_id`) REFERENCES `product` (`id`,`version_id`) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT `fk.blog_finder_mapping.blog_finder_id` FOREIGN KEY (`blog_finder_id`) REFERENCES `blog_finder` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;